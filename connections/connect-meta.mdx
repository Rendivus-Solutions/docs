...
- **AI Agent** at `/agent` reads and analyzes the connected account and can propose changes for your approval.
- **Ad Analytics** at `/ad-analytics` shows a live gallery of every ad with its metrics.
